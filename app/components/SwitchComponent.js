...
const SwitchWidth = (SCREEN_WIDTH*2/5-50)/2;
    ...
    return (
      <TouchableWithoutFeedback style={{justifyContent: 'center',}} onPress={this.handleSwitch}>
        ...
        >
          ...
          >
            {renderActiveText && (
              <Text style={[styles.text, styles.paddingRight, activeTextStyle, {color: "white",}]}>
                {activeText}
              </Text>
            )}
            ...
            {renderInActiveText && (
              <Text
                style={[styles.text, styles.paddingLeft, inactiveTextStyle, {color: "#666",}]}
              >
                {inActiveText}
              </Text>
            )}
